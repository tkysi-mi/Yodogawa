...
grep -oE "PostgreSQL|Redis|NestJS|Next.js" docs/project/design/01-tech-stack.md | sort -u
grep -oE "PostgreSQL|Redis|NestJS|Next.js" docs/project/design/07-architecture.md | sort -u
```
